...
final class SubmitQuizView: UIView {
...
private extension SubmitQuizView {
    func makeConstraints() {
        ...
        containerBottomConstraint = container.bottomAnchor.constraint(equalTo: bottomAnchor, constant: ScreenSize.isIphoneXFamily ? 298.scale : 258.scale)
        NSLayoutConstraint.activate([
            container.leadingAnchor.constraint(equalTo: leadingAnchor),
            container.trailingAnchor.constraint(equalTo: trailingAnchor),
            containerBottomConstraint,
            container.heightAnchor.constraint(equalToConstant: ScreenSize.isIphoneXFamily ? 298.scale : 258.scale)
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            submitButton.topAnchor.constraint(equalTo: subTitleLabel.bottomAnchor, constant: 20.scale)
        ])
...
private extension SubmitQuizView {
    ...
    func makeTitleLabel() -> UILabel {
        ...
        let view = UILabel()
        view.attributedText = "Question.SubmitQuiz.Title".localized.attributed(with: attrs)
        view.translatesAutoresizingMaskIntoConstraints = false
        container.addSubview(view)
        return view
    }
    ...
    func makeSubTitleLabel() -> UILabel {
        ...
        let string = String(format: "Question.SubmitQuiz.SubTitle".localized, answeredQuestionsCount, allQuestionsCount)
    ...
    func makeSubmitButton() -> UIButton {
        ...
        let view = UIButton()
        view.setAttributedTitle("Question.SubmitQuiz.SubmitQuiz".localized.attributed(with: attrs), for: .normal)
    ...
    func makeContinueButton() -> UIButton {
        ...
        let view = UIButton()
        view.setAttributedTitle("Question.SubmitQuiz.ContinueQuiz".localized.attributed(with: attrs), for: .normal)
